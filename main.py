...
def masg(call):
	...
	if call.data =="F1":
		...
		bot.send_sticker(call.message.chat.id,instagram,"GO TO START INSTAGRAM PLEASE\n SEND /insta IN BOOT" )
	if call.data =="F2":
		...
		bot.send_sticker(call.message.chat.id,facebook,"Welcome to Menu Facebook\nSEND /face IN BOOT" )
	if call.data =="F3":
		...
		bot.send_sticker(call.message.chat.id,tiktok,"Welcome to Menu TikTok\nSEND /tik IN BOOT" )
	if call.data =="F4":
		...
		bot.send_sticker(call.message.chat.id,snapchat,"Welcome to Menu SnapChat\nSEND /snap IN BOOT" )
	if call.data =="F5":
		...
		bot.send_sticker(call.message.chat.id,twi,"Welcome to Menu Twitter\nSEND /twi IN BOOT" )
